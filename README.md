...
- [order-service](#order-service)
  ...
  - [1. Prerequisites](#1-prerequisites)
  - [2. Get environment variables to connect to Azure Service Bus](#2-get-environment-variables-to-connect-to-azure-service-bus)
    - [2.1 option 1: Using Azure CLI](#21-option-1-using-azure-cli)
      - [2.1.1 Step 1: Create a Resource Group](#211-step-1-create-a-resource-group)
      - [2.1.2 Step 2: Create a Service Bus Namespace](#212-step-2-create-a-service-bus-namespace)
      - [2.1.3 Step 3: Create a Queue](#213-step-3-create-a-queue)
      - [2.1.4 Step 4: Choose an Authentication Method](#214-step-4-choose-an-authentication-method)
        - [2.1.4.1 Option A: Shared Access Policy (Connection String)](#2141-option-a-shared-access-policy-connection-string)
        - [2.1.4.2 Option B: Microsoft Entra Workload Identity (Recommended)\*\*](#2142-option-b-microsoft-entra-workload-identity-recommended)
      - [2.1.5 Step 5: Retrieve Hostname for the Queue](#215-step-5-retrieve-hostname-for-the-queue)
      - [2.1.6 Step 6: Save Environment Variables to a **.env**  **File**](#216-step-6-save-environment-variables-to-a-env--file)
    - [2.2 option 2 # Using Azure Portal](#22-option-2--using-azure-portal)
      - [2.2.1 Step 1: Create a Resource Group](#221-step-1-create-a-resource-group)
      - [2.2.2 Step 2: Create a Service Bus Namespace](#222-step-2-create-a-service-bus-namespace)
      - [2.2.3 Step 3: Create a Queue](#223-step-3-create-a-queue)
      - [2.2.4 Step 4: Choose an Authentication Method](#224-step-4-choose-an-authentication-method)
        - [2.2.4.1 Option A: Shared Access Policy (Connection String)](#2241-option-a-shared-access-policy-connection-string)
        - [2.2.4.2 Option B (Recommended): Microsoft Entra Workload Identity (Managed Identity)](#2242-option-b-recommended-microsoft-entra-workload-identity-managed-identity)
      - [2.2.5 Step 5: Retrieve Hostname for the Queue](#225-step-5-retrieve-hostname-for-the-queue)
      - [**2.2.6 Step 6: Save Environment Variables to a .env** File](#226-step-6-save-environment-variables-to-a-env-file)
